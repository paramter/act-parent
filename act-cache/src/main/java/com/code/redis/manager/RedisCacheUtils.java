...
import com.code.redis.manager.util.SpringContentLoader;
...
public class RedisCacheUtils {
    private static StringRedisTemplate stringRedisTemplate = (StringRedisTemplate) SpringContentLoader.getBean("redis-content.xml","stringRedisTemplate");
    private static RedisTemplate<String, Object> redisTemplate = (RedisTemplate<String, Object>) SpringContentLoader.getBean("redis-content.xml","redisTemplate");
